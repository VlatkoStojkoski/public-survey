...
export type PlaygroundIllustrationProps = {} & React.SVGProps<SVGSVGElement>;

export function PlaygroundIllustration({ ...props }: PlaygroundIllustrationProps) {
	return (
		<svg fill="currentColor" version="1.1" viewBox="0 0 512.042 512.042" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" {...props}>
