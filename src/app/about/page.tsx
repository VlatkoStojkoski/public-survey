	...
	return (
		<div className="mx-auto py-[calc(theme(spacing.navbar)+theme(spacing.6))] flex flex-col gap-y-6 items-center justify-center">
			<main className="prose mx-auto prose-invert">
				...
				<p>
					Општина Ѓорче Петров започна процес за вклучување на жителите при изготвување на Програмите за работа, проектите од витален интерес и на Буџетот за следната 2024 година.
				</p>
